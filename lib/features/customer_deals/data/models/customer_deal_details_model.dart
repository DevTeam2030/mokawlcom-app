...
class CustomerDealDetailsModel extends Equatable {
  const CustomerDealDetailsModel({
    required this.id,
    required this.title,
  ...
  factory CustomerDealDetailsModel.fromJson(Map<String, dynamic> json) {
    final rawCategories = json['categories'];
    final rawAttachments = json['attachments'];
    return CustomerDealDetailsModel(
